namespace day3 {
    ...
    function addWireToGrid(wireNum: number, loc: [number, number],
            dir: string, times: number): [number, number] {
        ...
        for (let i = 0; i < times; ++i) {
            ...
            if (grid[strLoc] != undefined && grid[strLoc] != wireNum) {
                let dist = Math.abs(loc[0] - 0) + Math.abs(loc[1] - 0);
